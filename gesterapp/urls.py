...
urlpatterns = patterns('gesterapp.views',
    ...
    url(r'^list-faltantes/$', 'list_faltantes', name='list-faltantes'),
    url(r'^list-devolver/$', 'list_devolver', name='list-devolver'),
    url(r'^devolver/(?P<pres_id>\d+)/$', 'devolver', name='devolver'),
    url(r'^get_usuarios/', 'get_usuarios', name='get-usuarios'),
)
